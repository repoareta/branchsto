			...
			<div class="d-flex flex-column-fluid">
				...
				<div class="container-fluid stable">
					<div class="stable-header">
						<a href="{{route('stable_approval2.index')}}" class="btn btn-back-page">
					...
					<div class="stable-body">
						<div class="row">
							<div class="col-md-3">
								<a href="{{route('stable_approval2.detail.horse', $data->user_id)}}">
							...
							<div class="col-md-3">
								<a href="{{route('stable_approval2.detail.package', $data->user_id)}}">
									<div class="card-action">
										<div class="image">
							...
							<div class="col-md-3">
								<a href="{{route('stable_approval2.detail.schedule', $data->user_id)}}">
									<div class="card-action">
										<div class="image">
							...
							<div class="col-md-3">
								<a href="{{route('stable_approval2.detail.coach', $data->user_id)}}">
									<div class="card-action">
										<div class="image">
						...
						<form action="{{route('stable_approval2.approv.stable', $data->id)}}" method="POST">
							@method('PATCH')
							@csrf
							@if (($horse_count > 0) and ($coach_count > 0) and ($package_count > 0) and ($slot_count > 0) and ($data_setup == 1))
								<button type="submit" class="btn btn-add-new mt-10">ACCEPT ALL</button>
							@else
								<button type="submit" class="btn btn-add-new mt-10" disabled>ACCEPT ALL</button>
							@endif
						</form>
					</div>
				</div>
...
<!--begin::Modal Stable-->
@include('app-owner.preview.stable.edit')
<!--end::Modal Stable-->
